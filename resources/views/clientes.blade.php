...
@section('content')
    ...
    <div id="div-nuevo-cliente" class="container">
        <a href="{!! url('/abm_acciones/nuevocliente') !!}" class="btn btn-primary" id="boton-nuevo-cliente"><span class="glyphicon glyphicon-plus"></span> Nuevo Cliente</a>
        <a href="{!! url('/excel/clientes') !!}" class="btn btn-success" id="boton-nuevo-cliente"><span class="glyphicon glyphicon-file"></span> Exportar a Excel</a>
    </div>

    <div class="container">
        <form class="form-group" method="post" action="{!! url('/abm/clientes') !!}">
            ...
            <tbody>
                @foreach($clientes as $cliente)
                    <tr>
                        ...
                        @foreach($clientestipo as $tipo)
                          @if($cliente->CD_ClienteTipo != $tipo->CD_ClienteTipo)
                            @continue
                          @endif
                        ...
                        <td>{{$cliente->Web}}</td>
                        <td>
                            <a href="{!! url("abm_acciones/mostrarcliente/".$cliente->CD_Cliente) !!}""><span class="label label-primary">Mostrar</span></a>
                            @if($cliente->FechaBaja == NULL)
                            <a href="{!! url("abm_acciones/editarcliente/".$cliente->CD_Cliente) !!}""><span class="label label-success">Editar</span></a>
                            <a href="{!! url("/eliminarcliente/".$cliente->CD_Cliente) !!}"><span class="label label-danger">Eliminar</span></a>
                            @endif
                        </td>
                    </tr>
                @endforeach
