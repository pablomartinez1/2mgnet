...
@section('content')
    ...
    <div id="div-agregado" class="container">
        <div id="boton-cerrar-form"><a href="{!! url('/abm/proveedores') !!}"><span id="glyph-cerrar" class="glyphicon glyphicon-remove"></span></a></div>
            <form id="form-agregar-cliente" class="form-group" method="post" action="{!! url('/crearproveedor') !!}">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-3">
                        <label>Horario: </label>
                        <input type="text" id="horario" name="comision" class="form-control" maxlength="6">
                    </div>
