...
@section('content')
    ...
    <div id="div-agregado" class="container">
        <div id="boton-cerrar-form"><a href="{!! url('/abm/clientes') !!}"><span id="glyph-cerrar" class="glyphicon glyphicon-remove"></span></a></div>
            <form id="form-agregar-cliente" class="form-group" method="post" action="{!! url('/crearcliente') !!}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="razonsocial" placeholder="Razon Social" class="form-control" maxlength="100">
                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="clientetipo">
                            ...
                            @foreach($clientetipo as $tipo)
                              @if($tipo->CD_ClienteTipo == 99)
                                @continue
                              @endif
                                <option value="{{$tipo->CD_ClienteTipo}}">{{$tipo->Descripcion}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="canal">
                            <option value="">Seleccione uno:</option>
                            @foreach($canal as $cana)
                                <option value="{{$cana->CD_Canal}}">{{$cana->Descripcion}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="rubroempresa">
                            <option value="">Seleccione uno:</option>
                            @foreach($empresarubro as $rubroempresa)
                                <option value="{{$rubroempresa->CD_EmpresaRubro}}">{{$rubroempresa->Descripcion}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="clienteclasificacion">
                            <option value="">Seleccione uno:</option>
                            @foreach($clienteclasificacion as $clasificacion)
                                <option value="{{$clasificacion->CD_ClienteClasificacion}}">{{$clasificacion->Descripcion}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
